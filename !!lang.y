...
statement:				type_definition SEMICOLON {
							$<node>$ = $<node>1;
						} 
...
variable_list:			| id COMMA variable_list;

type_definition:		id id variable_list {
							$<node>$ = nullptr;
						} |
						id LBRA type_list RBRA id variable_list {
							$<node>$ = nullptr;
						};

type_list:				type | id COMMA type_list;
