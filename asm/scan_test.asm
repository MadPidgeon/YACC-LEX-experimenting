section .data
	_def_1_data db 0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x49,0x20,0x72,0x65,0x61,0x64,0x3a,0x22
	_def_1 equ _def_1_data+8
	_def_2_data db 0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x22,0x0a
