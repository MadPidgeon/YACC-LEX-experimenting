section .data
	_def_1_data db 0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x73,0x74,0x72,0x31
	_def_1 equ _def_1_data+8
	_def_2_data db 0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x73,0x74,0x72,0x32
	_def_2 equ _def_2_data+8
	_def_3_data db 0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x73,0x74,0x72,0x33
	_def_3 equ _def_3_data+8
	_def_4_data db 0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x73,0x74,0x72,0x34
	_def_4 equ _def_4_data+8
	_def_5_data db 0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x73,0x74,0x72,0x35
...
_9:
	...
	mov qword [0+rax], 2
	lea r9, [8+rax]
	mov qword [-32+rbp], 10001
	lea r10, [0+_def_1]
	mov qword [-24+rbp], r10
	mov r10, 10001
	mov qword [0+r9], 10001
	mov r10, qword [-24+rbp]
	mov qword [8+r9], r10
	mov qword [-64+rbp], 10002
	lea r10, [0+_def_2]
	mov qword [-56+rbp], r10
	mov r10, 10002
	mov qword [16+r9], 10002
	mov r10, qword [-56+rbp]
	mov qword [24+r9], r10
	mov r8, qword [-8+rbp]
	mov qword [0+r8], r9
	mov rsi, 16
	...
	mov qword [0+rax], 1
	lea r9, [8+rax]
	mov qword [-104+rbp], 20001
	lea r10, [0+_def_3]
	mov qword [-96+rbp], r10
	mov r10, 20001
	mov qword [0+r9], 20001
	mov r10, qword [-96+rbp]
	mov qword [8+r9], r10
	mov r8, qword [-8+rbp]
	mov qword [8+r8], r9
	mov rsi, 24
	mov qword [-8+rbp], r8
	mov qword [-128+rbp], r9
	mov rax, 9
	xor rdi, rdi
	mov rdx, 3
	mov r10, 34
	...
	mov qword [0+rax], 2
	lea r9, [8+rax]
	mov qword [-144+rbp], 30001
	lea r10, [0+_def_4]
	mov qword [-136+rbp], r10
	mov r10, 30001
	mov qword [0+r9], 30001
	mov r10, qword [-136+rbp]
	mov qword [8+r9], r10
	mov qword [-176+rbp], 30002
	lea r10, [0+_def_5]
	mov qword [-168+rbp], r10
	mov r10, 30002
	mov qword [16+r9], 30002
	mov r10, qword [-168+rbp]
	mov qword [24+r9], r10
	mov r8, qword [-8+rbp]
	mov qword [16+r8], r9
	mov r9, r8
	...
	mov r9, qword [8+r8]
	mov qword [-224+rbp], r9
	mov r8, qword [-224+rbp]
	push r8
	call _1
_11:
	mov rax, 60
